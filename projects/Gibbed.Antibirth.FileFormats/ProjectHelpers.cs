...
namespace Gibbed.Antibirth.FileFormats
{
    public static class ProjectHelpers
    {
        ...
        {
            return manager.LoadLists("*.filelist", Rebirth.FileFormats.ArchiveFile.ComputeNameHash, Modifier);
        }

        public static ProjectData.HashList<ulong> LoadListsFileNames(this ProjectData.Project project)
        {
            return project.LoadLists("*.filelist", Rebirth.FileFormats.ArchiveFile.ComputeNameHash, Modifier);
        }
    }
}
